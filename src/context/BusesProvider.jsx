...
export const BusesProvider = ({ children }) => {
    ...
    const addDriverToDB = async (driver) => {
        ...
        if (!error) {
            ...
            alert(`Database Error! Failed to insert driver: ${error?.message || JSON.stringify(error)}`);
        }
    };
    ...
    const addRouteToDB = async (route) => {
        ...
        if (!error) {
            ...
            alert(`Database Error! Failed to insert route: ${error?.message || JSON.stringify(error)}`);
        }
    };
    ...
    const updateDriverToDB = async (driver) => {
        ...
        if (!error) {
            ...
            alert(`Database Error! Failed to update driver: ${error?.message || JSON.stringify(error)}`);
        }
    };
    ...
    const updateRouteToDB = async (route) => {
        ...
        if (!error) {
            ...
            alert(`Database Error! Failed to update route: ${error?.message || JSON.stringify(error)}`);
        }
    };
